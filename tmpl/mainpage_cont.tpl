...
<div class="container" id="main_container">
        ...
        <div class="col-md-12 header">
            <div id="header-mid">
                ...
                <div class="col-md-6 block_contact">
                    ...
                    <i class="fa fa-home fa-2x" style="float: left;"></i><p class="contact">г. Волжски, б-р Профсоюзов, 1б, офис 220</p>
                </div>
                <div class="col-md-3">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="block_widget">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block_obj_comfort_title">Удобства</div>
                        <div class="block_obj_comfort">
                            %comforts%
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="title_predl">Специальное предложение залупки:</div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            <div class="img_predl">Специальное предложение залупки:</div>
            <span class="text_predl"></span>
            <span class="desc_predl"></span>
        </div>
        <div class="col-md-3">
            <div class="img_predl">Специальное предложение залупки:</div>
            <span class="text_predl"></span>
